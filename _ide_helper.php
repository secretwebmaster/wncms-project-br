...
namespace Wncms\Facades {
    ...
    class Wncms {
         ...
         * @static
         */
        public static function registerModel($modelClass)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->registerModel($modelClass);
        }
        ...
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->getModelByKey($key);
        }
         ...
         * @static
         */
        public static function registerPackage($packageId, $packageFiles)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->registerPackage($packageId, $packageFiles);
        }
        ...
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->getRegisteredPackages();
        }
         ...
         * @static
         */
        public static function hasPackage($packageId)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->hasPackage($packageId);
        }
         ...
         * @static
         */
        public static function isPackageActive($packageId)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->isPackageActive($packageId);
        }
         ...
         * @static
         */
        public static function getActivePackageIds($seconds = 600)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->getActivePackageIds($seconds);
        }

        /**
         * @static
         */
        public static function getPackageMenus()
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->getPackageMenus();
        }

        /**
         * @static
         */
        public static function findManagerClass($managerPath, $packageId)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->findManagerClass($managerPath, $packageId);
        }
         ...
         * @static
         */
        public static function activatePackage($packageId)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->activatePackage($packageId);
        }
         ...
         * @static
         */
        public static function deactivatePackage($packageId)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->deactivatePackage($packageId);
        }
        ...
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->package($packageId);
        }
         ...
         * @static
         */
        public static function displayPrice($number, $digits = 2)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->displayPrice($number, $digits);
        }
         ...
         * @static
         */
        public static function normalizeDimension($value, $default = '200px')
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->normalizeDimension($value, $default);
        }
         ...
         * @static
         */
        public static function calculateAspect($aspect)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->calculateAspect($aspect);
        }
         ...
         * @static
         */
        public static function registerViewWidget($key, $view, $data = [])
        {
            /** @var \Wncms\Services\Wncms $instance */
            $instance->registerViewWidget($key, $view, $data);
        }
         ...
         * @static
         */
        public static function getViewWidgets($key)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->getViewWidgets($key);
        }
         ...
         * @static
         */
        public static function clearViewWidgets($key)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->clearViewWidgets($key);
        }
