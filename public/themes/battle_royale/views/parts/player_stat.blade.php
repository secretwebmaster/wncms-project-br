    ...
    <div class="card-body px-4 py-2">
        ...
        <div class="d-flex align-items-sm-center mb-1">
            ...
            <span class="badge badge-light fw-bold">
                {{ (int)$player->minAtk }} - {{ (int)$player->maxAtk }}
            </span>
        </div>
        ...
        <div class="d-flex align-items-sm-center mb-1">
            ...
            <span class="badge badge-light fw-bold">{{ (int)$player->def }}</span>
        </div>
        ...
        @foreach (['vit','str','int','dex','luc'] as $stat)
            <div class="d-flex align-items-sm-center mb-1">
                ...
                <span class="badge badge-light fw-bold">{{ $player->{$stat} }}</span>
            </div>
        @endforeach
