<div id="wncms_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#wncms_app_sidebar_mobile_toggle">
    ...
    <div class="app-sidebar-logo px-6" id="wncms_app_sidebar_logo">
        ...
        <span class="badge bg-info fw-bold text-white">v {{ gss('core_version', null, false) }}</span>
    </div>
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                {{-- Game --}}
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('frontend.pages.show', ['slug' => 'game']) }}">
                        ...
                        <span class="menu-title">@lang('wncms::word.start_game')</span>
                    </a>
                </div>
    ...
    @role(['super_admin', 'admin'])
        <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
            <a href="https://t.me/secretwebmaster" target="_blank" class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="200+ in-house components and 3rd-party plugins">
                <span class="btn-label">@lang('wncms::word.contact_support')</span>
